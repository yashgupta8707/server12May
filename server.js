...
app.use(cors({
  origin: ['http://localhost:3000', 'http://localhost:5173', 'https://www.yashgupta.engineer', 'https://12-may-frontend.vercel.app'],  // Allow both Create React App and Vite defaults
